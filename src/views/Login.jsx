...
export default function Login(props) {
  return (
    <div class="login-body overflow-hidden bg-blue-midgray">
      ...
      <div class="container-fluid container-md rounded my-0 my-md-5 mx-0 mx-md-auto overflow-hidden position-relative">
        <div class="row">
          <div class="col-sm-12 col-md-7 order-2 order-md-1 bg-blue-midgray pb-4">
            ...
            <div class="text-center w-75 d-block mx-auto">
              ...
              <p class="fs-6 text-light mb-0 mb-sm-5 py-3 py-sm-0">Aquí podrás encontrar información sobre tus unidades de formación del semestre.</p>
            </div>
          </div>
